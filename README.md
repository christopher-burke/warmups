...
|<a href="./python/misc/return_a_string_as_an_integer.py">python/misc/return\_a\_string\_as\_an\_integer.py</a>|Return a String as an Integer.|
...
|<a href="./python/misc/evaluate_an_equation.py">python/misc/evaluate\_an\_equation.py</a>|Evaluate an Equation.|
...
|<a href="./python/misc/using_the_and_operator.py">python/misc/using\_the\_and\_operator.py</a>|Using the "and" Operator.|
