...
|<a href="./python/misc/src/count_args.py">python/misc/src/count\_args.py</a>|Count the Arguments.|
...
|<a href="./python/misc/src/index_string_characters.py">python/misc/src/index\_string\_characters.py</a>|Return the Index of All Capital Letters.|
