...
|<a href="./src/index_string_characters.py">src/index\_string\_characters.py</a>|Return the Index of All Capital Letters.|
...
|<a href="./src/remove_smallest.py">src/remove\_smallest.py</a>|The Museum of Incredibly Dull Things.|
